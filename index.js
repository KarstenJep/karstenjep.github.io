...
function move() {
  ...
  html.style.bottom = 57 + incrementer * -0.01 + '%'
  css.style.left = 19 + incrementer * -.02 + '%'
  css.style.bottom = 56 + incrementer * -0.02 + '%'
  javascript.style.left = 31 + incrementer * -.03 + '%'
  javascript.style.bottom = 57 + incrementer * -0.03 + '%'
  react.style.left = 42 + incrementer * -.04 + '%'
  react.style.bottom = 57 + incrementer * -0.04 + '%'
  node.style.left = 53 + incrementer * .04 + '%'
  node.style.bottom = 57 + incrementer * -0.04 + '%'
  postgresql.style.left = 64 + incrementer * .03 + '%'
  postgresql.style.bottom = 57 + incrementer * -0.03 + '%'
  python.style.left = 75 + incrementer * .02 + '%'
  python.style.bottom = 57 + incrementer * -0.02 + '%'
  git.style.left = 86 + incrementer * .01 + '%'
  git.style.bottom = 57 + incrementer * -0.01 + '%'
